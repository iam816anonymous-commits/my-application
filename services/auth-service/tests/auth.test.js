...
test('POST /api/auth/workspaces & GET /api/auth/workspaces manage user workspaces', async () => {
    ...
    const { token, workspace: defaultWsp } = await regRes.json();
    ...
    const workspaces1 = await listRes1.json();
    ...
    const newWsp = await createRes.json();
    ...
    const workspaces2 = await listRes2.json();
